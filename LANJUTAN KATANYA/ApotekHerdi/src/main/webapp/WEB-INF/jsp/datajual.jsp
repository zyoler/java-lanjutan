                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <c:url var="inputjual" value="/doInsertJual"></c:url>
                            <a href="${inputjual}"><button type="button" class="btn btn-success" style="margin-bottom: 13px"><span class="fa fa-plus"></span> Tambah Penjualan </button></a>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <c:forEach var="jual" items="${jual}">
                                <tr>
                                    <td>${jual.tgl_beli}</td>
                                    <td>${jual.ref}</td>
                                    <td>${jual.nama_pembeli}</td>
                                    <td>${jual.banyak}</td>
                                    <td>Rp ${jual.grandtotal}</td>

                                    <td style=" text-align: center;">
                                        <c:url var="cetak" value="/cetakjual">
                                            <c:param name="ref" value="${jual.ref}"/>
                                        </c:url>
                                        <a href="${cetak}" class="btn btn-info btn-xs"> <span class="fa fa-newspaper-o"></span></a>
                                        <c:url var="hapus" value="/deleteDataJual">
                                            <c:param name="id_tagihan" value="${jual.id_tagihan}"/>
                                        </c:url>
