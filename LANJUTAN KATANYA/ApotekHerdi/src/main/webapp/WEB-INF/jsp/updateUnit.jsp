                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="/updateUnit" modelAttribut="unitDto" method="post" class="form-horizontal form-label-left" novalidate >


                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="unit">Nama Unit</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" id="id_unit" name="id_unit" path="id_unit" value="${unit.id_unit}" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" required="required">
                                        <input type="text" id="unit" name="unit" path="unit" value="${unit.unit}" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" required="required">
                                    </div>
                                </div>
