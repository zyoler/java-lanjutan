                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="/updateSupp" modelAttribute="suppDto" method="post" class="form-horizontal form-label-left" novalidate>
                                <input type="hidden" id="id_pem" name="id_pem" path="id_pem" value="${supp.id_pem}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1">
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Pemasok</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">

                                        <input type="text" id="nama_pemasok" name="nama_pemasok" path="nama_pemasok" value="${supp.nama_pemasok}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" required="required">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" >Alamat</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="alamat" name="alamat" path="alamat" value="${supp.alamat}" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="telepon" name="telepon" path="telepon" value="${supp.telepon}" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <c:url var="gosupp" value="/datasupp"></c:url>
                                        <a href="${gosupp}"><button type="button" class="btn btn-danger">Batal</button></a>
