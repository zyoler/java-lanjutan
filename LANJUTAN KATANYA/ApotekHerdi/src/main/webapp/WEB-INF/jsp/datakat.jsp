            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <c:url var="inputkat" value="/doInsertKat"></c:url>
                        <a href="${inputkat}"><button type="button" class="btn btn-success" style="margin-bottom: 13px"><span class="fa fa-plus"></span> Tambah Kategori </button></a>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <c:forEach var="kat" items="${kats}">
                            <tr>
                                <th scope="row">${kat.id_kat}</th>
                                <td>${kat.nama_kategori}</td>
                                <td>${kat.des_kat}</td>
                                <td style=" text-align: center;">
                                    <c:url var="edit" value="/doUpdateDataKat">
                                        <c:param name="id_kat" value="${kat.id_kat}"/>
                                    </c:url>
                                    <a href="${edit}" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span></a>
                                    <c:url var="hapus" value="/deleteDataKat">
                                        <c:param name="id_kat" value="${kat.id_kat}"/>
                                    </c:url>
