                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <c:url var="gobeli" value="/doInsertBeli"></c:url>
                            <a href="${gobeli}" class="btn btn-success" style="margin-bottom: 13px"><span class="fa fa-plus"></span> Tambah Pembelian </a>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <c:forEach var="beli" items="${beli}">
                                <tr>
                                    <td>${beli.tgl_beli}</td>
                                    <td>${beli.ref}</td>
                                    <td>${beli.nama_pemasok}</td>
                                    <td>${beli.banyak}</td>
                                    <td>Rp.${beli.grandtotal}</td>
                                    <td style=" text-align: center;">
                                        <c:url var="cetak" value="/ceatkbeli">
                                            <c:param name="ref" value="${beli.ref}"/>
                                        </c:url>
                                        <a href="${cetak}" class="btn btn-info btn-xs"><span class="fa fa-newspaper-o"></span></a>
                                        <c:url var="hapus" value="/deleteDataBeli">
                                            <c:param name="id_pembelian" value="${beli.id_pembelian}"/>
                                        </c:url>
                                        <a href="${hapus}" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span></a>
                                    </td>
                                </tr>
                                </c:forEach>
                                </tbody>
