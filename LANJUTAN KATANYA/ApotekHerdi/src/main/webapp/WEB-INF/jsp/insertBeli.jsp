                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form action="/saveBeli" modelAttribute="beliDto" method="post" class="form-horizontal form-label-left" novalidate>
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ref">Kode Referal</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="ref" name="ref" path="ref" value="" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="nama_pemasok" id="nama_pemasok" path="nama_pemasok" class="select2_single form-control nama_pemasok" tabindex="-1" required="required"><
                                                <option selected="true" value="" disabled ></option>
                                                <c:forEach var="sup" items="${supp}">
                                                    <option value="${sup.nama_pemasok}">${sup.nama_pemasok}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class='input-group date' id='myDatepicker2'>
                                                <input type="text" name="tgl_beli" id="tgl_beli" path="tgl_beli" class="form-control" data-date-format="YYYY-MM-DD" required="required">
                     ...
                     <span class="glyphicon glyphicon-calendar"></span>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <c:url var="gobeli" value="/databeli"></c:url>
                                            <a href="${gobeli}"><button type="button" class="btn btn-danger">Batal</button></a>
...
<script type="text/javascript">
    ...
    $('#addRow').on( 'click', function () {
        transaksi.row.add( [
            '<select required="required" style="width:100%;" class="form-control nama_obat" path="nama_obat[]" id="nama_obat'+counter+'" name="nama_obat[]" data-stok="#stok'+counter+'" data-unit="#unit'+counter+'" data-harga_jual="#harga_jual'+counter+'"><option selected="true" value="" disabled ></option><?php foreach($get_med as $gm){ ?><option value="<?php echo $gm; ?>"><?php echo $gm; ?></option><?php  }?></select>',
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for(i=0; i<data.nama_pemasok.length; i++){
                    html += '<option value="'+ data.nama_pemasok[i].nama_obat +'">'+data.nama_pemasok[i].nama_obat+'</option>';
                }
