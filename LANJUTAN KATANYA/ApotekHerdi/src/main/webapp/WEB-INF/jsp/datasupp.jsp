                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <c:url var="supp" value="/doInsertSupp"></c:url>
                            <a href="${supp}"><button type="button" class="btn btn-success" style="margin-bottom: 13px"><span class="fa fa-plus"></span> Tambah Pemasok </button></a>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <c:forEach var="supp" items="${sup}">
                                <tr>
                                    <th scope="row">${supp.id_pem}</th>
                                    <td>${supp.nama_pemasok}</td>
                                    <td>${supp.alamat}</td>
                                    <td>${supp.telepon}</td>
                                    <td style=" text-align: center;">
                                        <c:url var="edit" value="/doUpdateDataSupp">
                                            <c:param name="id_pem" value="${supp.id_pem}"/>
                                        </c:url>
                                        <a href="${edit}" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span></a>
                                        <c:url var="hapus" value="/deleteDataSupp">
                                            <c:param name="id_pem" value="${supp.id_pem}"/>
                                        </c:url>
