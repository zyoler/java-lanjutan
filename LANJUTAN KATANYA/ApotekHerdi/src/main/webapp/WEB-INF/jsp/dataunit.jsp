...
<%--                                </div>--%>
                                ...
                                <c:url var="insert" value="/doInsertUnit"></c:url>
                                <a href="${insert}"><button type="button" class="btn btn-success" style="margin-bottom: 13px"><span class="fa fa-plus"></span> Tambah Unit </button></a>
                                    ...
                                    <c:forEach var="unit" items="${unit}">
                                        <tr>
                                            ...
                                            <td style=" text-align: center;">
                                                <c:url var="edit" value="/doUpdateDataUnit">
                                                    <c:param name="id_unit" value="${unit.id_unit}"/>
                                                </c:url>
                                                <a href="${edit}" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span></a>
                                                <c:url var="hapus" value="/deleteDataUnit">
                                                    <c:param name="id_unit" value="${unit.id_unit}"/>
                                                </c:url>
