                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="/updateKat" modelAttribute="katDto" method="post" class="form-horizontal form-label-left" novalidate >


                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_kategori">Nama Kategori</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" id="id_kat" name="id_kat" path="id_kat" value="${kat.id_kat}" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" required="required">
                                        <input type="text" id="nama_kategori" name="nama_kategori" path="nama_kategori" value="${kat.nama_kategori}" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="des_kat" name="des_kat" path="des_kat" value="${kat.des_kat}" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <c:url var="kat" value="/datakat"></c:url>
                                        <a href="${kat}"><button type="button" class="btn btn-danger">Batal</button></a>
