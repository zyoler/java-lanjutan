    ...
    <div class="main_container">
                                ...
                                <section class="content invoice">
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-sm-4 invoice-col">
                                            Dari
                                            <address>
                                                <strong>Apotek Corona Dokter Herdiana</strong>
                                        ...
                                        <!-- /.col -->
                                        <div class="col-sm-4 invoice-col">
                                            <b>No Referensi: #${jual1[1]}</b>
                                            <br>
                                            <b>Total Pembelian: ${jual1[9]}</b>
                                            <br>
                                            <b>Tanggal: ${jual1[7]}</b>
                                            <br>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 table">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                <c:forEach var="idx" items="${jual}">
                                                <tr>
                                                    <td>${idx.nama_obat}</td>
                                                    <td>Rp ${idx.harga_jual}</td>
                                                    <td>${idx.banyak}</td>

                                                    <td>Rp ${idx.subtotal}</td>
                                                </tr>
                                                </c:forEach>
                                                </tbody>
                                                <tfoot>
        ...
        <footer>
            <div class="pull-right">
                <a href="https://http://rsh.fkh.ugm.ac.id/main/">Apotek Corona dr.Herdiana</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /Footer Content -->
