                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <?php endif; ?>
                                <c:url var="insertObat" value="/doInsertObat"></c:url>
                                <a href="${insertObat}"><button type="button" class="btn btn-success" style="margin-bottom: 13px"><span class="fa fa-plus"></span> Tambah Obat </button></a>
                                    ...
                                    <c:forEach var="obat" items="${obats}">
                                        <tr>
                                            ...
                                            <td style=" text-align: center;">
                                                <c:url var="edit" value="/doUpdateDataObat">
                                                    <c:param name="id_obat" value="${obat.id_obat}"/>
                                                </c:url>
                                                <a href="${edit}" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span></a>
                                                <c:url var="hapus" value="/deleteDataObat">
                                                    <c:param name="id_obat" value="${obat.id_obat}"/>
                                                </c:url>
