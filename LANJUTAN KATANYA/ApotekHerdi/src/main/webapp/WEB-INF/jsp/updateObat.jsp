...
<head>
    ...
    <title>Apotek Corona Dr.Herdiana</title>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form id="obat" action="/updateObat" method="post" modelAttribut="/obatDto" class="form-horizontal form-label-left" novalidate>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_obat">Nama Obat</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="id_obat" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" name="id_obat" path="id_obat" required="required" type="hidden" value="${obat.id_obat}">
                                        <input id="nama_obat" class="form-control col-md-7 col-xs-12" data-validate-length-range="1" data-validate-words="1" name="nama_obat" path="nama_obat" required="required" type="text" value="${obat.nama_obat}">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="penyimpanan" name="penyimpanan" path="penyimpanan" value="${obat.penyimpanan}" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="stok">Banyak Stok</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="stok" name="stok" path="stok" value="${obat.stok}" required="required" data-validate-minmax="0,1000" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="unit">Unit</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="unit" id="unit" path="unit" class="select2_single form-control" tabindex="-1" required="required">
                                            <option selected="true" value="" disabled ></option>
                                            <c:forEach var="unit" items="${unit}">
                                                <c:choose>
                                                    <c:when test="${unit.unit==obat.unit}">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  name="nama_kategori" id="nama_kategori" path="nama_kategori" class="select2_single form-control" tabindex="-1" required="required">
                                            <option selected="true" value="" disabled ></option>
                                            <c:forEach var="kat" items="${kat}">
                                                <c:choose>
                                                    <c:when test="${kat.nama_kategori==obat.nama_kategori}">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class='input-group date' id='myDatepicker2'>
                                            <input type="text" name="kedaluwarsa" id="kedaluwarsa" value="${obat.kedaluwarsa}" path="kedaluwarsa" data-date-format="YYYY-MM-DD" class="form-control" required>
                     ...
                     <span class="glyphicon glyphicon-calendar"></span>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea id="des_obat" name="des_obat" path="des_obat" class="form-control col-md-7 col-xs-12">${obat.des_obat}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="harga_beli" name="harga_beli" path="harga_beli" value="${obat.harga_beli}" required="required" data-validate-minmax="10,1000000" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="harga_jual" name="harga_jual" path="harga_jual" value="${obat.harga_jual}" required="required" data-validate-minmax="10,1000000" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_pemasok">Nama Pemasok</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="nama_pemasok" id="nama_pemasok" path="nama_pemasok" class="select2_single form-control" tabindex="-1" required="required">
                                            <option selected="true" value="" disabled ></option>
                                            <c:forEach var="supp" items="${supp}">
                                                <c:choose>
                                                    <c:when test="${supp.nama_pemasok==obat.nama_pemasok}">
                                                        <option value="${supp.nama_pemasok}" selected>${supp.nama_pemasok}</option>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <option value="${supp.nama_pemasok}">${supp.nama_pemasok}</option>
                                                    </c:otherwise>
                                                </c:choose>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <c:url var="goobat" value="/dataobat"></c:url>
                                        <a href="${goobat}"><button type="button" class="btn btn-danger">Batal</button></a>
