            ...
            <%-- isi konten--%>
                ...
                <div class="row top_tiles">
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <c:url var="inputobat" value="/doInsertObat"></c:url>
                        <a href="${inputobat}">
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <c:url var="inputpem" value="/doInsertSupp"></c:url>
                        <a href="${inputpem}">
                            <div class="tile-stats">
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <c:url var="obatexp" value="/dataobatexp"></c:url>
                        <a href="${obatexp}">
                            <div class="tile-stats">
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <c:url var="obatstok" value="/dataobatoutstok"></c:url>
                        <a href="${obatstok}">
                            <div class="tile-stats">
