...
<%--                    </div>--%>
            ...
            function transChart(){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i in data){
                            total.push(data.charts[i].total);
                            month.push(data.charts[i].month);
                        }
        ...
        <script>
            ...
            function purChart(){
                ...
                $.ajax({
                    type: "POST",
                    url: "/Rest-data/getChartPurchaseData",
                    dataType: "JSON",
                    data: { "tahun_beli": tahun_beli },
                    success: function(data) {
                        ...
                        for (var i=0; i<data.chartBeli.length;i++ ){
                            total.push(data.chartBeli[i][1]);
                            month.push(data.chartBeli[i][0]);
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for(i=0; i<data.topPurchase.length; i++){
                            html += '<tr >'+
                                '<td>'+(i+1)+'</td>'+
                                '<td>'+data.topPurchase[i][0]+'</td>'+
                                '<td>'+data.topPurchase[i][1]+'</td>'+
                                '</tr>';
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for(i=0; i<data.leastPurchase.length; i++){
                            html += '<tr >'+
                                '<td>'+(i+1)+'</td>'+
                                '<td>'+data.leastPurchase[i][0]+'</td>'+
                                '<td>'+data.leastPurchase[i][1]+'</td>'+
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for(i=0; i<data.highestPurchase.length; i++){
                            html += '<tr >'+
                                '<td>'+(i+1)+'</td>'+
                                '<td>'+data.highestPurchase[i][0]+'</td>'+
                                '<td>'+data.highestPurchase[i][1]+'</td>'+
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for(i=0; i<data.lowestPurchase.length; i++){
                            html += '<tr >'+
                                '<td>'+(i+1)+'</td>'+
                                '<td>'+data.lowestPurchase[i][0]+'</td>'+
                                '<td>'+data.lowestPurchase[i][1]+'</td>'+
