...
<div class="container" align="center">
    ...
    <form:form id="pengunjung" action="/saveCheckInUser" modelAttribute="pengunjungDto" method="POST">
        <table class="tab">
            <tr>
                <td>No KTP :</td>
                <td>
            ...
            <tr>
                <td colspan="2">
                    <form:button type="submit" class="buttonSimpan" id="save">Simpan</form:button>
                </td>
            </tr>
        </table>
    </form:form>
