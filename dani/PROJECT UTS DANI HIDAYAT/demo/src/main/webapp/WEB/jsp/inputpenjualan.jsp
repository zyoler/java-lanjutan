...
<body id="page-top">
<form:form id="penjualan" action="/tambahPenjualan" modelAttribute="jualDto" method="POST">
                        ...
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto">
                                ...
                                <div class="col-xl-5 col-lg-7">
                                    <i> Nama Obat : </i>
                                    <form:select path="id_obat" name="id_obat" required="required">
                                        <c:forEach var="obat" items="${obatModels}">
                                            <form:option value="${obat.id_obat}">${obat.nama}</form:option>
                                        </c:forEach>
                                    </form:select>
                                </div>
                                <br>
                                <div class="col-xl-5 col-lg-7">
                                    <i> Jumlah Beli : </i>
                                    <form:input path="banyak" type="text" placeholder="Jumlah beli" class="form-control form-control-user" pattern="[0-9]{1,20}" required="required"/>
                                </div>
                                <br>
                                <div class="col-xl-5 col-lg-7">
                                    <form:button type="submit" id="save" class="btn btn-success btn-block">Simpan Obat
                                    </form:button>

                                    <c:url var="penj2" value="/inputPenjualan2"/>
                                    <a class="btn btn-success btn-block" href="${penj2}">Selanjutnya</a>
                                </div>
                                <br>
                            </form>
                        </div>
