...
<body id="page-top">
<form:form id="obat" action="/saveUpdateObat" modelAttribute="obatDto" method="POST">
    <form:hidden path="id_obat" value="${obatDto.id_obat}"/>
<!-- Page Wrapper -->
<div id="wrapper">
                    ...
                    <div class="col-xl-12 col-lg-7">
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto">
                                ...
                                <div class="col-xl-5 col-lg-7">
                                    <i> Unit : </i> <br>
                                    <form:radiobutton path="unit" name="unit" value="Tablet" required="required"/> Tablet <br>
