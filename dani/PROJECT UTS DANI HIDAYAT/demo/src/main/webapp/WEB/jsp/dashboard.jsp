    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo8" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <c:url var="pembelian" value="/pembelian"/>
                    <a class="collapse-item" href="${pembelian}">Input Pembelian</a>
                    <c:url var="datapembelian" value="/datapembelian"/>
                    <a class="collapse-item" href="${datapembelian}">Data Pembelian</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo6" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <c:url var="penjualan" value="/inputPenjualan"/>
                    <a class="collapse-item" href="${penjualan}">Input Penjualan</a>
                    <c:url var="datapenjualan" value="/datapenjualan"/>
                    <a class="collapse-item" href="${datapenjualan}">Data Penjualan</a>
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"> Hallo, Selamat Datang Admin </h1>
                </div>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        <div class="card border-left-secondary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1"> Total Pelanggan </div>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        <div class="card border-left-warning shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"> Total Pemasok </div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"> ${jumlahPemasok} </div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        <div class="card border-left-danger shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1"> Total Obat </div>
