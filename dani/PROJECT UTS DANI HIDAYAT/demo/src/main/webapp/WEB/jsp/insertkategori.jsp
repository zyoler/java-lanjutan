...
<body id="page-top">
<form:form id="peg" action="/saveKategori" modelAttribute="kategoriDto" method="POST">
                        ...
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto">
                                ...
                                <div class="col-xl-5 col-lg-7">
                                    <i> Nama Kategori : </i>
                                    <form:input path="nama" type="text" placeholder="Nama Kategori" class="form-control form-control-user" pattern="[A-Za-z ]{3,30}" required="required"/>
                                </div>
                                <br>
                                <div class="col-xl-5 col-lg-7">
                                    <i> Keterangan : </i>
                                    <form:input path="keterangan" type="text" placeholder="Keterangan" class="form-control form-control-user" pattern="[A-Za-z ]{3,30}" required="required"/>
                                </div>
                                <br>
