...
<body id="page-top">
<form:form id="peg" action="/savePegawai" modelAttribute="pegawaiDto" method="POST">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"> Input Data Pegawai </h1>
                </div>
                        ...
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto">
                                ...
                                <div class="col-xl-5 col-lg-7">
                                    ...
                                    <form:radiobutton path="jk" name="jk" value="Laki-laki" id="activeRadio"/> Laki-laki
                                ...
                                <div class="col-xl-5 col-lg-7">
                                    <i> Password : </i>
                                    <form:input path="password" type="password" placeholder="password" class="form-control form-control-user" pattern="{1,30}" required="required"/>
                                </div>
