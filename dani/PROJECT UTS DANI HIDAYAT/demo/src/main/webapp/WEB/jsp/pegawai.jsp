                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form:form action="/searchPegawai" modelAttribute="cari" method="POST">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                <c:forEach var="var" items="${Pegawai}">
                                <tr>
                                    <td> ${var.id_peg} </td>
                                    <td> ${var.nama} </td>
                                    <td> ${var.jk} </td>
