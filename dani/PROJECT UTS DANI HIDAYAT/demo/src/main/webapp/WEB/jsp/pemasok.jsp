            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Data Tabel Pemasok</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <form:form action="/searchPemasok" modelAttribute="cari" method="POST">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                <c:forEach var="var" items="${Pemasok}">
                                    <tr>
                                        <td> ${var.id_peg} </td>
                                        <td> ${var.nama} </td>
                                        <td> ${var.alamat} </td>
