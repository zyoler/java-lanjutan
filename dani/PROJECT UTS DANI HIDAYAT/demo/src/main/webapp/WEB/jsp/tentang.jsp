                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="card shadow mb-5">
                            <div class="col-md-auto">
                                ...
                                <br>
                                <h5 align="justify">
                                    Apotek ZYO adalah sebuah aplikasi yg berbasis web yang menyediakan, meramu dan menjual obat berdasarkan resep dokter atau keluhan ringan lainnya.
                                </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-7">
                        <div class="card shadow mb-5">
                            <div class="col-md-auto">
                                <br>
                                <h4 align="center">
                                    Tujuan web ini dibuat
                                </h4>
                                <br>
                                <h5 align="justify">
                                    Aplikasi ini dibuat untuk memudahkan penyimpanan data dan bertransaksi disini. Aplikasi ini hanya dikhususkan untuk admin yang bisa menambahkan data pegawai, pelanggan, pemasok, kategori serta menambahkan data obat. Data obat yang ditambahkan harus termasuk dalam kategori serta pemasok yang telah diinputkan sebelumnya.
                                </h5>
                                <br>
                                <br>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="card shadow mb-5">
                            <div class="col-md-auto">
                                ...
                                <br>
                                <h5 align="justify">
                                    Tentu masih banyak kekurangan yang terjadi pada website ini, jadi bagi teman-teman yang ingin bertanya atau ingin menyampaikan kritik dan saran silahkan menuju "Contact Us". Kritik dan sarannya akan sangat berharga bagi kami.
                                </h5>
                                <br>
                                <br>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="card shadow mb-5">
                            <div class="col-md-auto">
                                ...
                                <br>
                                <h5 align="justify">
                                    Saya berharap semoga aplikasi ini dapat bermanfaat bagi apoteker dan teman-teman semuanya. Terima kasih:)
                                </h5>
                                <br>
                                <br>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="card shadow mb-5">
                            <div class="col-md-auto">
                                <br>
                                <h4 align="center">
                                    FUN FACT asal kata ZYO?
                                </h4>
                                <br>
                                <h5 align="justify">
                                    Asal kata "zyo" diambil dari pembuatan akun pertama yang dilakukan si pembuat website ini dalam game growtopia. Kata "zyo" memiliki banyak kenangan karena dalam semua game yang dimainkan oleh pembuat website ini memiliki nickname "zyo".
                                </h5>
                            </div>
                        </div>
                    </div>
