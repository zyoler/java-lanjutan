...
<body id="page-top">
<form:form id="peg" action="/saveUpdatePemasok" modelAttribute="pemasokDto" method="POST">
    <form:hidden path="id_peg" value="${pemasokDto.id_peg}"/>
    <!-- Page Wrapper -->
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Edit Data Pemasok </h1>
                    </div>
                            ...
                            <div class="card shadow mb-5">
                                <form class="user col-md-auto">
                                    ...
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Nama Pemasok : </i>
                                        <form:input path="nama" type="text" placeholder="Nama Pemasok" class="form-control form-control-user" pattern="[A-Za-z ]{3,30}" required="required"/>
                                    </div>
                                    <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Alamat : </i>
