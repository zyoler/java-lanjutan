                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form:form action="/searchKategori" modelAttribute="cari" method="POST">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                <c:forEach var="var" items="${Kategori}">
                                <tr>
                                    <td> ${var.id_kat} </td>
                                    <td> ${var.nama} </td>
                                    ...
                                    <td>
                                        <div class="col-md-auto">
                                            <c:url var="delete" value="/deleteKategori">
                                                <c:param name="id" value="${var.id_kat}"/>
                                            </c:url>
