...
<body id="page-top">
<form:form id="peg" action="/savePelanggan" modelAttribute="pelangganDto" method="POST">
    <form:hidden path="level" value="classic"/>
                            ...
                            <div class="card shadow mb-5">
                                <form class="user col-md-auto">
                                    ...
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Nama Pelanggan : </i>
                                        <form:input path="nama" type="text" placeholder="Nama Pelanggan" class="form-control form-control-user" pattern="[A-Za-z ]{3,30}" required="required"/>
                                    </div>
                                    <br>
                                    <div class="col-xl-5 col-lg-7">
