...
<body id="page-top">
<form:form id="penjualan" action="/savePenjualan" modelAttribute="jualDto" method="POST">
                        ...
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto">
                                ...
                                <div class="col-xl-5 col-lg-7">
                                    <i> Kode Referal : </i>
                                    <form:input path="referal" type="text" placeholder="Jumlah beli" class="form-control form-control-user" pattern="[0-9]{1,20}" required="required"/>
                                </div>
                                <br>
                                <div class="col-xl-5 col-lg-7">
                                    <i> Nama Pembeli : </i>
                                    <form:select path="namapembeli" name="namapembeli" required="required">
                                        <c:forEach var="pem" items="${pelanggan}">
                                            <form:option value="${pem.nama}">${pem.nama}</form:option>
                                        </c:forEach>
                                    </form:select>
                                </div>
                                <br>
                                <div class="col-xl-5 col-lg-7">
                                    <i> Tagihan : </i>
                                    <form:input path="subtotal" type="${total}" placeholder="Jumlah beli" class="form-control form-control-user" pattern="[0-9]{1,20}" required="required"/>
                                </div>
                                <br>
                                <div class="col-xl-5 col-lg-7">
                                    <i> Jumlah uang : </i>
                                    <form:input path="jumlah" type="text" placeholder="Jumlah beli" class="form-control form-control-user" pattern="[0-9]{1,20}" required="required"/>
                                </div>
                                <br>
                                <div class="col-xl-5 col-lg-7">
